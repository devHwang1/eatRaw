...
public final class FragmentAlarmBinding implements ViewBinding {
  ...
  private FragmentAlarmBinding(@NonNull FrameLayout rootView, @NonNull SwitchCompat alarmSwitch) {
  ...
  public static FragmentAlarmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      SwitchCompat alarmSwitch = ViewBindings.findChildViewById(rootView, id);
      if (alarmSwitch == null) {
        break missingId;
      }

      return new FragmentAlarmBinding((FrameLayout) rootView, alarmSwitch);
    }
